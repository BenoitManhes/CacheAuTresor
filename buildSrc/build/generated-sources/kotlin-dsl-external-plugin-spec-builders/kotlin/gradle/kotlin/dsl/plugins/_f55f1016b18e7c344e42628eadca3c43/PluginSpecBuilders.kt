...
package gradle.kotlin.dsl.plugins._f55f1016b18e7c344e42628eadca3c43
...
/**
 * The `de.fayard` plugin group.
 */
@org.gradle.api.Generated
internal
class `DeFayardPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `de.fayard`.
 */
internal
val `DePluginGroup`.`fayard`: `DeFayardPluginGroup`
    get() = `DeFayardPluginGroup`(plugins)


/**
 * The `de.fayard.refreshVersions` plugin implemented by [de.fayard.refreshVersions.RefreshVersionsPlugin].
 */
internal
val `DeFayardPluginGroup`.`refreshVersions`: PluginDependencySpec
    get() = plugins.id("de.fayard.refreshVersions")


/**
 * The `de.fayard.refreshVersions-core` plugin implemented by [de.fayard.refreshVersions.core.RefreshVersionsCorePlugin].
 */
internal
val `DeFayardPluginGroup`.`refreshVersions-core`: PluginDependencySpec
    get() = plugins.id("de.fayard.refreshVersions-core")
