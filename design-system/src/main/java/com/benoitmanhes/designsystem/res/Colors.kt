...
internal object Colors {
    ...
    val CarrotOrange: Color = Color(0xFFF0962C)
    val DarkCerulean: Color = Color(0xFF0F3A7A)
    ...
    val FrenchLilac: Color = Color(0xFF7B5F8E)
    val MiddleGreen: Color = Color(0xFF53A160)
    val NewYorkPink: Color = Color(0xFFD28988)
    val PewterBlue: Color = Color(0xFF94B0B3)
