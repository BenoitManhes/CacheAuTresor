...
sealed class CTRemoteError(
    ...
    data class AuthenticationInvalidCredentialError(override val cause: Throwable?) : CTRemoteError(cause, "Invalid password")
    data class AuthenticationEmailInvalidForm(override val cause: Throwable?) : CTRemoteError(cause, "User email not found")
    data class AuthenticationUserEmailNoExist(override val cause: Throwable?) : CTRemoteError(cause, "User email not found")
