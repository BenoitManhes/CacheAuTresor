...
data class EditCrewNameModalBottomSheet(
    ...
    override fun Content(
        ...
        var textValue: String by remember { mutableStateOf(initialText.orEmpty()) }
        ...
        CTModalBottomSheetContent(
            ...
            modifier = Modifier
                .animateContentSize()
                .imePadding(),
            title = TextSpec.Resources(R.string.modalEditCrewName_title),
            ...
            CTOutlinedTextField(
                value = textValue,
                onValueChange = {
                    textValue = it.take(DomainConstants.EditCache.maxCrewNameLenght)
                    showError = false
                },
